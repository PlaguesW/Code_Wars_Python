...
# ate the cookie. If the input is a float oe an int then "Monica" ate the cookie. If the input is anything else
# "the dog" ate the cookie. The way to return the statement is: "Who ate the last cookie? It was (name)!"

# Example: "hi" --> Output = "Who ate the last cookie? It was Zach!
